import{i as E,a as L,C as S,O as b,R as g,b as A,x as l,d as C,m as W,n as D,A as d,o as j,e as _,f as u,k as I,p as T,S as y,q,M as O,T as P}from"./index-kzqfanXf.js";import{n as z,r as c,c as k,o as v}from"./if-defined-DOGcsOOe.js";import{O as R}from"./index-BepVrb2O.js";import{e as F}from"./index-DNtnM4a-.js";import"./index-CjQyJJ7j.js";import"./index-Bacb8VyM.js";import"./index-Bkqzb4wQ.js";import"./index-Dn9wYPRB.js";import"./index-TL39HMEc.js";import"./index-CGK7ZNkq.js";import"./ref-BiJRpoBm.js";import"./ConstantsUtil-Dmg8YACJ.js";import"./index-DV2p36pn.js";import"./index-vxX1E91M.js";const M=E`
  :host {
...
`;var w=function(s,e,i,o){var r=arguments.length,t=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(s,e,i,o);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(t=(r<3?n(t):r>3?n(e,i,t):n(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let h=class extends L{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=S.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.features=b.state.features,this.isPwaLoading=!1,this.unsubscribe.push(S.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),b.subscribeKey("features",e=>this.features=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.features?.socials||[];const i=!!this.authConnector,o=e?.length,r=g.state.view==="ConnectSocials";return(!i||!o)&&!r?null:(r&&!o&&(e=A.DEFAULT_FEATURES.socials),l` <wui-flex flexDirection="column" gap="xs">
      ${e.map(t=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await F(e)}async handlePwaFrameLoad(){if(C.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof W&&await this.authConnector.provider.init()}catch(e){D.open({shortMessage:"Error loading embedded wallet in PWA",longMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};h.styles=M;w([z()],h.prototype,"tabIdx",void 0);w([c()],h.prototype,"connectors",void 0);w([c()],h.prototype,"authConnector",void 0);w([c()],h.prototype,"features",void 0);w([c()],h.prototype,"isPwaLoading",void 0);h=w([k("w3m-social-login-list")],h);const N=E`
  wui-flex {
